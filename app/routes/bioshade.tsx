    ...
    <section className="pb-40 pt-[72px]">
      <div id="bioshade">
        ...
        <div id="body" className="">
          ...
          <a data-aos="fade-up" className="inline-block mt-8 text-white font-semibold py-2.5 px-8 rounded bg-gradient-main" href="file.pdf" target="_blank">Build the Future 2049</a>
        </div>
      </div>
    </section>
  );
