        ...
        <div className="bg-white p-10 rounded-2xl text-black flex flex-col gap-10 lg:gap-24">
          <div className="flex justify-between">
            ...
            <div className="flex flex-col text-right">
              ...
              <a href="tel:+351927812110" className="text-xs font-semibold">
                +351 927 812 110
              </a>
              <a href="mailto:hello@ngc.bio" className="text-xs font-semibold">
                hello@ngc.bio
              </a>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center flex-col lg:flex-row text-center sm:text-left gap-6">
            ...
            <div>
              <img src="/images/footer-logos.svg" alt="Footer logos" />
            </div>
          </div>
        </div>

        <div className="flex gap-2">
          <h3 className="uppercase text-4xl font-extrabold lg:w-1/2">
