  ...
  return (
    <section className="container mx-auto px-10 py-20">
      ...
      <div className="relative overflow-hidden w-[290px] h-[448px] mx-auto">
        ...
        >
          <div>
            <h3 className="text-xl font-medium font-jakarta uppercase">Plantcovid</h3>
            <p className="mt-2 text-xs font-poppins uppercase">Product research and application of naturally occurring anti-microbial compounds.</p>
          </div>
        </div>
      </div>
    </section>
